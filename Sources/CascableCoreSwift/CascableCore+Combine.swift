...
public extension Camera {
    ...
    ///
    /// The created publisher will immediately publish the property's current value.
    ///
    ...
    ///
    /// The created publisher will immediately publish the property's current valid settable values.
    ///
    /// - Parameter propertyIdentifier: The property identifier to create a publisher for.
    @available(iOS 13.0, macOS 10.15, *)
